\subsection{Оптимальная стратегия студента}
...
(Рис. \ref{fig:l_B_limits}).

\begin{figure}[H]
	\centering
  	\includegraphics[scale=0.45]{part_3/graf_3_2}
  	\caption{}
  	\label{fig:l_B_limits}
\end{figure}
\begin{flushleft}
	Найдём значение $\mu$, при котором прямая $\ell_B(q, \mu)$ проходит через 
	точку $q=(0,0)$:
\end{flushleft}
$$
	\ell_B(0,0,\hat \mu) = 0
